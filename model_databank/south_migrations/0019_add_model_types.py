...
# Use a DataMigration to populate ModelType instances
MODEL_TYPE_DATA = [
    {'name': '3Di', 'slug': '3di'},
    {'name': '3Di (urban)', 'slug': '3di-urban'},
]

class Migration(DataMigration):
    """Migration for pre-populating ModelType instances."""
    def forwards(self, orm):
        "Write your forwards methods here."
        # Note: Don't use "from appname.models import ModelName". 
        # Use orm.ModelName to refer to models in this application,
        # and orm['appname.ModelName'] for models in other applications.
        for mt in MODEL_TYPE_DATA:
            orm.ModelType.objects.get_or_create(name=mt['name'],
                                                slug=mt['slug'])

    def backwards(self, orm):
        "Write your backwards methods here."
        for mt in MODEL_TYPE_DATA:
            model_type = orm.ModelType.objects.get(slug=mt['slug'])
            model_type.delete()
