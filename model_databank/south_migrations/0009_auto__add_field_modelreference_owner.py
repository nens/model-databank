...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelReference.owner'
        db.add_column('model_databank_modelreference', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelReference.owner'
        db.delete_column('model_databank_modelreference', 'owner_id')
