...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelUpload.model_type'
        db.add_column(u'model_databank_modelupload', 'model_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['model_databank.ModelType'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelUpload.model_type'
        db.delete_column(u'model_databank_modelupload', 'model_type_id')
    ...
    models = {
        ...
        u'model_databank.modeltype': {
            'Meta': {'ordering': "(u'pk',)", 'object_name': 'ModelType'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'model_databank.modelupload': {
            ...
            'model_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['model_databank.ModelType']", 'null': 'True'}),
            'organisation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lizard_auth_client.Organisation']", 'null': 'True', 'blank': 'True'}),
