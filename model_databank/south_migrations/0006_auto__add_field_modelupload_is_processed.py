...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelUpload.is_processed'
        db.add_column('model_databank_modelupload', 'is_processed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelUpload.is_processed'
        db.delete_column('model_databank_modelupload', 'is_processed')
