...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Migrate content from comment field to description field."
        # Note: Remember to use orm['appname.ModelName'] rather than "from appname.models..."
        for model_reference in orm['model_databank.ModelReference'].objects.all():
            if model_reference.comment and not model_reference.description:
                model_reference.description = model_reference.comment
