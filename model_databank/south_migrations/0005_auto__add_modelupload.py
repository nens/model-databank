...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ModelUpload'
        db.create_table('model_databank_modelupload', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('model_reference', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'uploads', null=True, to=orm['model_databank.ModelReference'])),
        ...
        db.send_create_signal('model_databank', ['ModelUpload'])


    def backwards(self, orm):
        # Deleting model 'ModelUpload'
        db.delete_table('model_databank_modelupload')
    ...
    models = {
        ...
        'model_databank.modelupload': {
            ...
            'model_reference': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'uploads'", 'null': 'True', 'to': "orm['model_databank.ModelReference']"}),
        ...
        'model_databank.version': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'model_reference': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'versions'", 'null': 'True', 'to': "orm['model_databank.ModelReference']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
