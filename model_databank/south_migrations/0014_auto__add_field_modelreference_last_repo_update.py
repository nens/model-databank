...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelReference.last_repo_update'
        db.add_column(u'model_databank_modelreference', 'last_repo_update',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelReference.last_repo_update'
        db.delete_column(u'model_databank_modelreference', 'last_repo_update')
