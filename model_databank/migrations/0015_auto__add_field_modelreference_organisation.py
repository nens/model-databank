...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelReference.organisation'
        db.add_column(u'model_databank_modelreference', 'organisation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_auth_client.Organisation'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelReference.organisation'
        db.delete_column(u'model_databank_modelreference', 'organisation_id')
