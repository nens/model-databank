...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelReference.is_deleted'
        db.add_column('model_databank_modelreference', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelReference.is_deleted'
        db.delete_column('model_databank_modelreference', 'is_deleted')
