...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelReference.type'
        db.add_column(u'model_databank_modelreference', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['model_databank.ModelType'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'ModelType.slug'
        db.alter_column(u'model_databank_modeltype', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from=u'name'))

    def backwards(self, orm):
        # Deleting field 'ModelReference.type'
        db.delete_column(u'model_databank_modelreference', 'type_id')


        # Changing field 'ModelType.slug'
        db.alter_column(u'model_databank_modeltype', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from=u'identifier'))
    ...
    models = {
        ...
        u'model_databank.modelreference': {
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['model_databank.ModelType']", 'null': 'True', 'blank': 'True'}),
