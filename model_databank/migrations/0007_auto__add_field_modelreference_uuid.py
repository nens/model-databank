...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelReference.uuid'
        db.add_column('model_databank_modelreference', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelReference.uuid'
        db.delete_column('model_databank_modelreference', 'uuid')
