...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelReference.description'
        db.add_column('model_databank_modelreference', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelReference.description'
        db.delete_column('model_databank_modelreference', 'description')
