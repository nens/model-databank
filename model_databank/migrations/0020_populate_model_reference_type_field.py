...
class Migration(DataMigration):
    """Migration for populating the ModelReference type field. We can assume
    that all models are 3Di models."""
    def forwards(self, orm):
        ...
        # ModelType instances are added by the previous migration
        model_type = orm.ModelType.objects.get(slug='3di')
        for mref in orm.ModelReference.objects.all():
            mref.type = model_type
            mref.save()
