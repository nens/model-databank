...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelUpload.organisation'
        db.add_column(u'model_databank_modelupload', 'organisation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_auth_client.Organisation'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelUpload.organisation'
        db.delete_column(u'model_databank_modelupload', 'organisation_id')
