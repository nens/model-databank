...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Version.model_reference'
        db.add_column('model_databank_version', 'model_reference',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'versions', null=True, to=orm['model_databank.ModelReference']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Version.model_reference'
        db.delete_column('model_databank_version', 'model_reference_id')
