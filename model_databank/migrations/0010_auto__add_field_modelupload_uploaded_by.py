...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelUpload.uploaded_by'
        db.add_column('model_databank_modelupload', 'uploaded_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelUpload.uploaded_by'
        db.delete_column('model_databank_modelupload', 'uploaded_by_id')
